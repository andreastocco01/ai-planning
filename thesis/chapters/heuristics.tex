...
considered. For this instance, the only suboptimal plan that the pruning-enhanced heuristic might produce is $\langle a_2, a_6, a_{10}, a_{13}, a_{15}\rangle$.
...
Figure \ref{fig:sp_scheme} illustrates the same example introduced in Section \ref{sec:hmax}, but evaluated with the newly presented heuristic.
